...
fibonacci="""
00 read r1      # n to r1
01 setn r2 0    # assign r2 as 0 initially
02 setn r3 1    # assign r3 as 1 initially
03 jeqzn r1 11  # if n is 0, jump to ending line and stop
04 write r2     # write the current term
05 add r4 r2 r3 # adding the two previous terms (add r4 r3 r2)
06 copy r2 r3   # assign first term to second term
07 copy r3 r4   # assign second term to third term
08 addn r1 -1   # decrease number of terms
09 jeqzn r1 11  # jump to ending line if # of terms is 0
10 jgtzn r1 03  # jump to the beginning (line 3)
11 halt         # stop program 
